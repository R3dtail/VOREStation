...
/obj/item/clothing/gloves/combat //Combined effect of SWAT gloves and insulated gloves
	desc = "These tactical gloves are somewhat fire and impact resistant in addition to being shock absorbant." //Mild clarification compared to swat gloves since otherwise the only difference text wise is a hyphen
	name = "Combat gloves"
	icon_state = "swat"
	item_state = "swat"
